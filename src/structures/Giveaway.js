...
const tslib_1 = require("tslib"),
  discord_giveaways_1 = require("discord-giveaways"),
  discord_js_1 = require("discord.js"),
  GiveawayModel_1 = tslib_1.__importDefault(require("../models/GiveawayModel")),
  replaceAll_1 = tslib_1.__importDefault(require("../helpers/replaceAll"));
class ExtendedGiveawaysManager extends discord_giveaways_1.GiveawaysManager {
  generateMainEmbed(e) {
  ...
  generateEndEmbed(e, a) {
    const t = a.map((e) => `${e}`).join("\n"),
      i = (0, replaceAll_1.default)(
        this.client.messages.Embeds.GiveawayEndEmbed,
        {
          "{description}": e.extraData.description || "",
    ...
    return (
      e.extraData.image || delete i.image,
      new discord_js_1.EmbedBuilder(i)
    );
  }
  generateNoValidParticipantsEndEmbed(e) {
    const a = (0, replaceAll_1.default)(
      this.client.messages.Embeds.GiveawayEndEmbed,
      {
        "{description}": e.extraData.description || "",
        "{timestamp}": Math.round(e.endAt / 1e3),
    ...
    return (
      e.extraData.image || delete a.image,
      new discord_js_1.EmbedBuilder(a)
    );
  }
  getAllGiveaways() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      return yield GiveawayModel_1.default.find().lean();
    });
  }
  saveGiveaway(e, a) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      return (yield GiveawayModel_1.default.create(a), !0);
    });
  }
  editGiveaway(e, a) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      return (yield GiveawayModel_1.default.updateOne({ messageId: e }, a), !0);
    });
  }
  deleteGiveaway(e) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      return (yield GiveawayModel_1.default.deleteOne({ messageId: e }), !0);
    });
  }
}
exports.default = ExtendedGiveawaysManager;
