...
const tslib_1 = require("tslib"),
  ...
  types_1 = require("util/types"),
  __1 = require("../.."),
  ratingValues = ["One", "Two", "Three", "Four", "Five"];
exports.default = new Event_1.Event("guildTicketDeleted", (e, t) =>
  tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const i = yield e
      ...
      .catch(() => !1)
      .then((e) => e);
    if ((0, types_1.isBooleanObject)(i)) return;
    const s = yield i.awaitMessageComponent({
        filter: (t) => t.user.id === e.id,
    ...
    (yield s.reply({
      ...
      yield GuildModel_1.default.findOneAndUpdate(
        { guildId: e.guild.id },
        {
          $push: {
            ticketReviews: { userId: e.id, staffId: t.staffClaimed, rating: o },
          },
        },
      ));
  }),
);
const generateComponents = (e = !1) => [
