    ...
    tslib_1.__awaiter(void 0, void 0, void 0, function* () {
      ...
      const s =
          (null === (i = e.options) || void 0 === i
            ? void 0
            : i.getUser("user")) || e.user,
        r = yield (0, getUser_1.default)(s.id, e.guild.id),
        { invites: o, bonus: n, fake: l, join: d, left: a } = r;
      e.reply({
        embeds: [
          (0, replaceAll_1.default)(t.messages.Embeds.UserInvitesEmbed, {
            "{user-tag}": s.tag,
            "{total}": o.length + n,
            "{join}": d.length,
            "{left}": a.length,
