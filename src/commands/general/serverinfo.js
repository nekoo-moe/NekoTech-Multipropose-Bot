    ...
    tslib_1.__awaiter(void 0, void 0, void 0, function* () {
      const { guild: r } = e,
        ...
        l = s.filter((e) => {
          var i, r;
          return (
            (null === (i = e.presence) || void 0 === i ? void 0 : i.status) &&
            "offline" !==
              (null === (r = e.presence) || void 0 === r ? void 0 : r.status)
          );
        }).size,
        o = s.size - l;
      e.reply({
        embeds: [
          (0, replaceAll_1.default)(i.messages.Embeds.ServerInfoEmbed, {
            "{server-name}": r.name,
            "{server-icon}": r.iconURL({ size: 4096 }),
            "{owner-id}": r.ownerId,
            "{createdTimestamp}": Math.floor(r.createdTimestamp / 1e3),
            "{online-members}": l,
            ...
            "{channels}": r.channels.cache.size,
            "{ticketRating}": (0, calculateReviews_1.default)(
              t.ticketReviews || [],
            ),
          }),
        ],
