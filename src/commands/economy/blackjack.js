...
const tslib_1 = require("tslib"),
  ...
  generateBlacjackBoard_1 = tslib_1.__importDefault(
    require("../../helpers/images/generateBlacjackBoard"),
  ),
  ...
  __1 = require("../.."),
  imageQuery = { extension: "png", forceStatic: !0 },
  defaultCard = {
    suit: "??",
    path: "back-card.png",
    rank: { name: "??", value: 0 },
...
function generateDeck() {
  ...
  for (const a of suits)
    for (const t of ranks)
      e.push({ suit: a, rank: t, path: `${t.name}_of_${a}.png` });
  return (shuffleDeck(e), e);
}
...
function getHandValue(e) {
  let a = 0,
    t = !1;
  for (const n of e) ((a += n.rank.value), "ace" === n.rank.name && (t = !0));
  return (t && a <= 11 && (a += 10), a);
}
function generateActionButtons(e = !1) {
  return [
    new discord_js_1.ActionRowBuilder().addComponents(
      new discord_js_1.ButtonBuilder()
        .setStyle(
          (0, parseStyle_1.default)(
            __1.client.messages.Buttons.BlackJackHit.Style,
          ),
        )
        .setLabel(__1.client.messages.Buttons.BlackJackHit.Label)
        .setDisabled(e)
        .setCustomId("hit"),
      new discord_js_1.ButtonBuilder()
        .setStyle(
          (0, parseStyle_1.default)(
            __1.client.messages.Buttons.BlackJackStand.Style,
          ),
        )
        .setLabel(__1.client.messages.Buttons.BlackJackStand.Label)
        .setDisabled(e)
        .setCustomId("stand"),
    ),
  ];
