...
exports.default = new Command_1.Command({
  name: "daily",
  description: "Nhận phần quà điểm danh hàng ngày",
  run: ({ interaction: e, client: l }) =>
    tslib_1.__awaiter(void 0, void 0, void 0, function* () {
      ...
      const r = new Date(),
        ...
        o = new Date(t.dailyReward);
      return r < o
        ? e.reply({
            embeds: [
              (0, replaceAll_1.default)(l.messages.Embeds.DailyMustWaitEmbed, {
                "{time}": Math.floor(o.getTime() / 1e3),
              }),
            ],
          })
        : ((t.dailyReward = r.setDate(r.getDate() + 1)),
          (t.balance.bank +=
            (null === (i = null == s ? void 0 : s.economyConfig) || void 0 === i
              ? void 0
              : i.dailyReward) || 2500),
          yield t.save(),
          e.reply({
            embeds: [
              (0, replaceAll_1.default)(l.messages.Embeds.DailyClaimedEmbed, {
                "{user-tag}": e.user.tag,
                ...
                "{amount}":
                  ...
                  void 0 === a
                    ...
                    : a.dailyReward) || 2500,
                "{coin}":
                  null === (d = null == s ? void 0 : s.economyConfig) ||
                  void 0 === d
                    ? void 0
                    : d.coin,
              }),
