...
exports.default = new Command_1.Command({
  ...
  run: ({ client: e, interaction: s }) =>
    tslib_1.__awaiter(void 0, void 0, void 0, function* () {
      var l;
      if (!(0, isVoiceChannel_1.default)(s)) return;
      const r = e.distube.getQueue(s.guildId);
      return (
        null === (l = null == r ? void 0 : r.songs) || void 0 === l
          ? void 0
          : l.length
      )
        ? (r.resume(),
          s.reply({
            embeds: [
              (0, replaceAll_1.default)(e.messages.Embeds.MusicResumeEmbed),
            ],
          }))
        : s.reply({
            embeds: [
