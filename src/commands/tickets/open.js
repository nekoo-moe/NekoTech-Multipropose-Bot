  ...
  run: ({ interaction: e, client: s }) =>
    tslib_1.__awaiter(void 0, void 0, void 0, function* () {
      ...
      if (!t.isClosed)
        return e.reply({
          embeds: [
            (0, replaceAll_1.default)(s.messages.Embeds.TicketIsNotClosed),
          ],
        });
      for (const s of t.usersInTicket)
        yield e.channel.permissionOverwrites
          .edit(s, { ViewChannel: !0 })
          .catch((e) => e);
      (yield e.reply({
        embeds: [
        ...
        components: [
          new discord_js_1.ActionRowBuilder().addComponents(
            new discord_js_1.ButtonBuilder()
              ...
              .setStyle(
                (0, parseStyle_1.default)(s.messages.Buttons.TicketClose.Style),
              )
            ...
            new discord_js_1.ButtonBuilder()
              ...
              .setStyle(
                (0, parseStyle_1.default)(s.messages.Buttons.TicketClaim.Style),
              )
