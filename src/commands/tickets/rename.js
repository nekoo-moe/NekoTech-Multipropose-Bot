...
exports.default = new Command_1.Command({
  ...
  run: ({ client: e, interaction: n }) =>
    tslib_1.__awaiter(void 0, void 0, void 0, function* () {
      if (n.channel.type !== discord_js_1.ChannelType.GuildText) return;
      const i = n.options.getString("name"),
        t = yield TicketModel_1.default.findOne({
          guildId: n.guildId,
          channelId: n.channelId,
        });
      return t
        ? (yield n.channel.edit({ name: i }),
          (t.channelName = i),
          yield t.save(),
          n.reply({
            embeds: [
              (0, replaceAll_1.default)(
                e.messages.Embeds.TicketChannelRenamed,
                { "{name}": i },
              ),
            ],
          }))
