        ...
        return e.reply({
          embeds: [
            (0, replaceAll_1.default)(
              s.messages.Embeds.ChannelIsNotATicketEmbed,
            ),
          ],
        });
      if (t.isClosed)
        return e.reply({
          embeds: [
            (0, replaceAll_1.default)(s.messages.Embeds.TicketAlreadyClosed),
          ],
        });
      for (const s of t.usersInTicket)
        yield e.channel.permissionOverwrites.edit(s, { ViewChannel: !1 });
        ...
        components: [
          new discord_js_1.ActionRowBuilder().addComponents(
            new discord_js_1.ButtonBuilder()
              ...
              .setStyle(
                (0, parseStyle_1.default)(
                  s.messages.Buttons.TicketTranscript.Style,
                ),
              )
            ...
            new discord_js_1.ButtonBuilder()
              ...
              .setStyle(
                (0, parseStyle_1.default)(s.messages.Buttons.TicketOpen.Style),
              )
            ...
            new discord_js_1.ButtonBuilder()
              ...
              .setStyle(
                (0, parseStyle_1.default)(
                  s.messages.Buttons.TicketDelete.Style,
                ),
              )
          ...
          components: [
            new discord_js_1.ActionRowBuilder().addComponents(
              new discord_js_1.ButtonBuilder()
                ...
                .setStyle(
                  (0, parseStyle_1.default)(
                    s.messages.Buttons.TicketClose.Style,
                  ),
                )
              ...
              new discord_js_1.ButtonBuilder()
                ...
                .setStyle(
                  (0, parseStyle_1.default)(
                    s.messages.Buttons.TicketClaim.Style,
                  ),
                )
