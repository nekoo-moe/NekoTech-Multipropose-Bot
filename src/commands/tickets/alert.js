  ...
  run: ({ interaction: e, client: l }) =>
    tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        return e.reply({
          embeds: [
            (0, replaceAll_1.default)(
              l.messages.Embeds.ChannelIsNotATicketEmbed,
            ),
          ],
        });
      ...
      try {
        (yield r.send({
          embeds: [
            (0, replaceAll_1.default)(l.messages.Embeds.TicketAlertUserEmbed, {
              "{user-tag}": r.user.tag,
              "{user-id}": r.id,
          ...
          yield e.reply({
            embeds: [
              (0, replaceAll_1.default)(
                l.messages.Embeds.TicketAlertCorrectEmbed,
                { "{user-tag}": r.user.tag },
              ),
            ],
          }));
        ...
        yield e.reply({
          embeds: [
            (0, replaceAll_1.default)(l.messages.Embeds.TicketAlertWrongEmbed),
          ],
        });
      }
    }),
