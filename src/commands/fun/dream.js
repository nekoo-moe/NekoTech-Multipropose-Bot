...
const tslib_1 = require("tslib"),
  ...
  API_URL = "https://paint.api.wombo.ai/api/v2/tasks/",
  STYLES = [
    { name: "Buliojourney v2", value: 84 },
    { name: "Realistic v2", value: 78 },
    { name: "Spectral v2", value: 92 },
    { name: "Flora v2", value: 81 },
    { name: "Watercolor v2", value: 91 },
    { name: "Blues v2", value: 88 },
    { name: "Unrealistic v2", value: 89 },
    { name: "VFX v2", value: 79 },
    { name: "Expressionism", value: 77 },
    { name: "Figure", value: 76 },
    { name: "HDR", value: 52 },
    { name: "Spectral", value: 63 },
    { name: "Comic", value: 45 },
    { name: "Soft Touch", value: 71 },
    { name: "Splatter", value: 74 },
    { name: "Festive", value: 73 },
    { name: "Winter", value: 72 },
    { name: "Realistic", value: 32 },
    { name: "Flora", value: 68 },
    { name: "Diorama", value: 65 },
    { name: "Abstract", value: 67 },
    { name: "Fantastical", value: 61 },
    { name: "Vector", value: 60 },
    { name: "Cartoonist", value: 58 },
    { name: "Bad Trip", value: 57 },
  ];
...
const signUp = () =>
    tslib_1.__awaiter(void 0, void 0, void 0, function* () {
      return new Promise((e) => {
        axios_1.default
          .post(
            "https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyDCvp5MTJLUdtBYEKYWXJrlLzu1zuKM6Xw",
            {},
          )
          .then(function (t) {
            e(t.data);
  ...
  createTask = (e, t, a) => {
    const i = {
      input_spec: { display_freq: 10, prompt: t, style: a },
      is_premium: !1,
    };
    return new Promise((t, a) => {
      axios_1.default
        ...
        .then(function (e) {
          var a;
          t(null === (a = e.data) || void 0 === a ? void 0 : a.id);
        })
        .catch(function (e) {
          a(e);
        });
        ...
        axios_1.default
          ...
          .then(function (i) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
              let o = i.data;
              for (; "completed" != o.state && "failed" != o.state; ) {
                try {
                  o = (yield axios_1.default.get(API_URL + t, {
                    headers: {
  ...
  generateImage = (e, t) =>
    tslib_1.__awaiter(void 0, void 0, void 0, function* () {
      ...
      const i =
          null ===
            (a = yield tslib_1.__awaiter(void 0, void 0, void 0, function* () {
              return new Promise((e) => {
                axios_1.default
                  .post(
                    "https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyDCvp5MTJLUdtBYEKYWXJrlLzu1zuKM6Xw",
            ...
            ? void 0
            : a.idToken,
        o = yield createTask(i, t, e);
      return yield checkStatus(i, o);
    });
