...
exports.default = new Command_1.Command({
  ...
  run: ({ interaction: e, client: i }) =>
    tslib_1.__awaiter(void 0, void 0, void 0, function* () {
      ...
      return (
        null === (t = null == n ? void 0 : n.verifySettings) || void 0 === t
          ? void 0
          : t.roleId
      )
        ? (yield s.send({
            embeds: [
              (0, replaceAll_1.default)(
                i.messages.Embeds.VerificationMainEmbed,
            ...
            components: [
              new discord_js_1.ActionRowBuilder().addComponents(
                new discord_js_1.ButtonBuilder()
                  .setCustomId("verify")
                  .setEmoji(i.messages.Buttons.Verification.Emoji)
                  .setStyle(
                    (0, parseStyle_1.default)(
                      i.messages.Buttons.Verification.Style,
                    ),
                  )
                  .setLabel(i.messages.Buttons.Verification.Label),
              ),
            ],
          }),
          e.followUp({
